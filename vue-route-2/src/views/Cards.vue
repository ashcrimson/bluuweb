    ...
    <div class="mt-5">
        ...
        <b-row class="mt-5">
            <b-col cols="12" md="4">
                ...
                img-top
                >
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum labore dignissimos impedit, libero quis iure ex explicabo eaque velit, aliquam a! Deleniti repellendus saepe corporis omnis sequi nisi necessitatibus magnam.</p>
